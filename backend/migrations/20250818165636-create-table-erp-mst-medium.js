...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('erp_mst_mediums', {
      mst_medium_id: { type: Sequelize.INTEGER, autoIncrement: true, primaryKey: true },
  ...
  down: async (queryInterface, Sequelize) => {
    await queryInterface.dropTable('erp_mst_mediums');
    if (queryInterface.sequelize.getDialect() === 'postgres') {
      await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_erp_mst_mediums_is_active";');
    }
  }
};
