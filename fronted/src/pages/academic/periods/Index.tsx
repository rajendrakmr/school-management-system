...
import { useGetPeriodsQuery } from "@/store/slice/academics/periods";
...
const Index: React.FC = () => {
  ...
  const { data: dataRecords, isFetching, refetch } = useGetPeriodsQuery(
