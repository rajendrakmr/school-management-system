...
import { useGetDeptsQuery } from "@/store/slice/academics/department";
...
const Index: React.FC = () => {
  ...
  const { data: dataRecords, isFetching, refetch } = useGetDeptsQuery(
