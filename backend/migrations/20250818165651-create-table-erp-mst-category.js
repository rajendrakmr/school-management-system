...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('erp_mst_categories', {
      mst_category_id: { type: Sequelize.INTEGER, autoIncrement: true, primaryKey: true },
  ...
  down: async (queryInterface, Sequelize) => {
    await queryInterface.dropTable('erp_mst_categories');
    if (queryInterface.sequelize.getDialect() === 'postgres') {
      await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_erp_mst_categories_is_active";');
    }
  }
};
