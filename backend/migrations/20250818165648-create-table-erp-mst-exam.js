...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('erp_mst_exams', {
      mst_exam_id: { type: Sequelize.INTEGER, autoIncrement: true, primaryKey: true },
      ...
      exam_type: { type: Sequelize.ENUM('formative', 'summative', 'board'), defaultValue: 'formative' },
  ...
  down: async (queryInterface, Sequelize) => {
    await queryInterface.dropTable('erp_mst_exams');
    if (queryInterface.sequelize.getDialect() === 'postgres') {
      await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_erp_mst_exams_is_active";');
      await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_erp_mst_exams_exam_type";');
    }
  }
};
