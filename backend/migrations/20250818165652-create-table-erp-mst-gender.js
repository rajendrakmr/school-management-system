...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('erp_mst_genders', {
      mst_gender_id: { type: Sequelize.INTEGER, autoIncrement: true, primaryKey: true },
  ...
  down: async (queryInterface, Sequelize) => {
    await queryInterface.dropTable('erp_mst_genders');
    if (queryInterface.sequelize.getDialect() === 'postgres') {
      await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_erp_mst_genders_is_active";');
    }
  }
};
