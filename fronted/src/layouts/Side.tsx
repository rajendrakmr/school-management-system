...
//  import * as Icons from '@fortawesome/free-solid-svg-icons';
import { IconDefinition } from '@fortawesome/fontawesome-svg-core'; // ✅ Add this
                  ...
                  >
                    <div className="d-flex align-items-center gap-2">
                      {menuItem.icon && (
                        ...
                        <FontAwesomeIcon icon={Icons[menuItem.icon as keyof typeof Icons] as IconDefinition} />
                      ...
                      <div>
                        <ul className="p-0 accordion-body child-route-con">
                          {menuItem.children.map((childItem: any, childIndex: number) => (
                            ...
                            >
                              <Link to={childItem.path} className="c-route-link d-flex align-items-center">

                                {/* Dot instead of arrow */}
                                <span className={`menu-dot ${currentPath === childItem.path ? 'active-dot' : ''}`}></span>

                                <span className={`c-cl-w ${currentPath === childItem.path ? 'childActiveColor' : ''}`}>
                                  {childItem.name}
                                </span>
