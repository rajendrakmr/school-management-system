...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('erp_mst_streams', {
      mst_stream_id: { type: Sequelize.INTEGER, autoIncrement: true, primaryKey: true },
  ...
  down: async (queryInterface, Sequelize) => {
    await queryInterface.dropTable('erp_mst_streams');
    if (queryInterface.sequelize.getDialect() === 'postgres') {
      await queryInterface.sequelize.query('DROP TYPE IF EXISTS "enum_erp_mst_streams_is_active";');
    }
  }
};
